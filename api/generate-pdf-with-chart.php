<?php
// File: api/generate-pdf-with-chart.php
// API endpoint to generate PDF report for assessment with chart images
...
$html = generateAcademicReportWithChartImages($assessment, $results, $summary, $groupedResponses, $chartImages);
...
function generateAcademicReportWithChartImages($assessment, $results, $summary, $groupedResponses, $chartImages) {
    $html = '
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class="header">
            ...
            <div class="institution">Program Studi Teknologi Informasi - Universitas [Nama Institusi]</div>
        </div>
        ...
        <div class="section">
            ...
            if (!empty($chartImages)) {
                ...
                $html .= '
                <div class="chart-container">
                    <p>Gambar visualisasi maturity level akan ditampilkan di sini.</p>
                    <p>Dalam implementasi sebenarnya, chart interaktif dari halaman web akan dikonversi ke gambar statis dan disisipkan di sini.</p>
                </div>';
            }
